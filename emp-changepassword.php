...
$username = $_SESSION['emplogin'];
    ...
    $sql = "SELECT Password FROM tblemployees WHERE EmailId=:username";
...
$query = "UPDATE tblemployees SET Password=:newpassword WHERE EmailId=:username";

$hashpassword = password_hash($_POST["newpassword"],PASSWORD_DEFAULT);
$chngpwd1 = $dbh->prepare($query);
$chngpwd1-> bindParam(':username', $username, PDO::PARAM_STR);
$chngpwd1-> bindParam(':newpassword', $hashpassword, PDO::PARAM_STR);
$chngpwd1->execute();
