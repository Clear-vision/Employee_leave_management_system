            ...
            <header class="mn-header navbar-fixed">
                ...
                $sql = "SELECT tblleaves.id AS lid,tblemployees.FirstName,
                      ...
                      FROM tblleaves JOIN tblemployees ON tblleaves.empid=tblemployees.id
                       WHERE tblleaves.IsRead=:isread ORDER BY lid DESC";
                $query = $dbh->prepare($sql);
                $query->bindParam(':isread',$isread,PDO::PARAM_STR);
                $query->execute();
                $results = $query->fetchAll(PDO::FETCH_OBJ);
                ...
                {               ?>
                                    ...
                                    <li>
                                        ...
                                        <div class="notification">
                                            ...
                                            <div class="notification-text"><p><b><?php echo htmlentities($result->FirstName." ".$result->LastName);?><br />(<?php echo htmlentities($result->EmpId);?>)</b> applied for leave</p><span>at <?php echo htmlentities(date('F d, Y - h:i:s A',strtotime($result->PostingDate)));?></b</span></div>
                                        </div>
                                        </a>
                                    </li>
                                   <?php }} ?>
