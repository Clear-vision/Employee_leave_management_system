            ...
            <main class="mn-inner">
                ...
                ?>
                            ...
                            <div class="card invoices-card">
                             ...
                             <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            <th>S/N</th>
                                            <th width="200">Employee's Image</th>
                                            <th width="200">Employee's Name</th>
                    ...
                    $sql = "SELECT tblleaves.id AS lid,tblemployees.FirstName,
                             tblemployees.LastName,tblemployees.EmpId,tblemployees.emp_image,tblemployees.id,
                             tblleaves.LeaveType,tblleaves.PostingDate,
                             tblleaves.Status FROM tblleaves JOIN tblemployees 
                             ON tblleaves.empid = tblemployees.id ORDER BY lid DESC limit 6";
                    $query = $dbh -> prepare($sql);
                    $query->execute();
                    $results=$query->fetchAll(PDO::FETCH_OBJ);
                    $cnt = 1;
