                ...
                <div class="row">
                    ...
                    {               ?>
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities(date('F d, Y h:i:s A',strtotime($result->CreationDate)));?></td>
                                            <td><a href="editleavetype.php?lid=<?php echo htmlentities($result->id);?>"><i class="material-icons-edit"></i>Edit</a>
                                            <a href="manageleavetype.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you want to delete');">
                                                <i class="material-icons-delete"></i>Delete</a> </td>
                                        </tr>
                                         <?php $cnt++;} }?>
                                    </tbody>
                                </table>
