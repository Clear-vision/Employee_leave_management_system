...
$query = "UPDATE tblemployees SET Password=:newpassword WHERE id=:empid";
                                      ...
                                      <span class="card-title" style="font-size:20px;">Employee details</span>
                                       ...
                                       <div class="row">
                                           <form class="col s12" name="signin" method="post">
                                               ...
                                               <div class="input-field col s12">
                                                   <button type="submit" name="Submit" class="waves-effect waves-light btn  m-b-xs">Submit</button>
