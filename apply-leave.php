...
<input placeholder="" id="mask1" name="fromdate"  type="text" data-inputmask="'alias': 'date'" class="datepicker" required>
</div>
<div class="input-field col m6 s12">
<label for="todate">To Date</label>
<input placeholder="" id="mask1" name="todate"  type="text" data-inputmask="'alias': 'date'" class="datepicker" required>
</div>
