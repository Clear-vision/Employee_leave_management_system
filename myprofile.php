...
$sql = "UPDATE tblemployees SET FirstName=:fname,LastName=:lname,Gender=:gender,
        Dob=:dob,Department=:department,Address=:address,City=:city,Country=:country,
...
<label for="empcode">Employee's Code</label>
...
<div class="input-field col m6 s12">
    <label for="depaartment">Department</label>
    <br />
